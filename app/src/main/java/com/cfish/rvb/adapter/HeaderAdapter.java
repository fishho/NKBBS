...
public class HeaderAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public HeaderAdapter(Context mContext,Article header,Author author,List<Reply> replyList) {
    ...
    public void refreshData(List<Reply> replyList) {
        this.replyList = replyList;
...
//            }
            ...
            if (reply.getCreatime() == null) {
                ...
                itemHolder.actReply.setTag(reply.getG_r_id() + "`" + reply.getUser().name);
