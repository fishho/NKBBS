...
import com.cc.dfish.nkbbs.util.HttpUtil;
...
public class CircleImageView extends ImageView {
     ...
     * e.g http://site.kk/uploads/pic.jpg;
     */
    public void setImageURL(String url) {
        HttpUtil.get(url,new BinaryHttpResponseHandler() {
            @Override
            public void onSuccess(int stateCode, Header[] arg1, byte[] data) {
                // TODO Auto-generated method stub
                Bitmap bm =  BitmapFactory.decodeByteArray(data, 0, data.length);
                setImageBitmap(bm);
            }
            @Override
            public void onFailure(int stateCode, Header[] arg1, byte[] arg2, Throwable arg3) {
                // TODO Auto-generated method stub
                Log.d("FF","失败了");
            }
        });
